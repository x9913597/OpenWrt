...
# 修改默认IP
# sed -i 's/192.168.10.251/10.0.0.1/g' package/base-files/files/bin/config_generate
...
sed -i "s/${orig_version}/R${date_version} by Xwey/g" package/lean/default-settings/files/zzz-default-settings
